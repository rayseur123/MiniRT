...
/*   Updated: 2025/09/01 15:21:44 by njooris          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vcthead	*vector_realloc(t_vcthead *vcthead)
{
	...
	new_vcthead = ft_realloc(vcthead, sizeof(t_vcthead) + (vcthead->capacity * vcthead->element_size),
...
size_t vector_alloc(t_vector vector, size_t nb_new_element)
{
	...
	new_head = ft_realloc(old_head, sizeof(t_vcthead) + (old_head->capacity * old_head->size),
