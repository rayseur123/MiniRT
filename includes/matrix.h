...
t_matrix3_ptr	matrix4_submatrix(t_matrix4 m1, t_matrix3 m2,
					int row, int col);
...
t_matrix4_ptr	matrix4_multiplication(t_matrix4 m1, t_matrix4 m2,
					t_matrix4 m3);
t_matrix4_ptr	matrix3_multiplication(t_matrix3 m1, t_matrix3 m2,
					t_matrix4 m3);
t_tuple			matrix4_multiplication_by_tuple(t_matrix4 m1, t_tuple t1);
t_matrix4_ptr	matrix2_multiplication(t_matrix2 m1, t_matrix2 m2,
					t_matrix4 m3);
